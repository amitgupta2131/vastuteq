        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <a class="nav-link" href="#">Home <span class="sr-only">(current)</span></a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link  text-dark dropdown-toggle menu-item" href="#" id="navbarDropdown" role="button"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-dark menu-item" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Edit
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown ml-2 mr-2">
                        <a class="nav-link tool menu-item" href="#" role="button" data-tool="select"><img src="<?php echo base_url('assets/icons/bezier.svg')?>" alt="tool" width="20"></a>
                    </li>
                </ul>
